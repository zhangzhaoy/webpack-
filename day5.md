...
## webpack安装方式--本地安装
1. 运行`npm install --save-dev webpack`本地安装webpack，这样就能在本地使用webpack的命令
...
```
webpack3 的打包用法。若失败，请参考https://www.jianshu.com/p/a55fb5bf75e1
webpack .\src\main.js .\dist\bundle.js

若打包失败，更换打包命令为: (webpack4的打包用法)
